...
def run_pipeline():
    print("⚠️ *[DEPRECATED] 此脚本已弃用，请使用 data_manager.py 中的 UnifiedPersistenceManager*")
    print("⚠️ *[DEPRECATED] This script is legacy code. Logic has been moved to UnifiedPersistenceManager.*")
    print("🚀 启动数据清洗与入库流水线...")
